...
final class PaymentController
{
        ...
        if (!Schema::paymentsReady()) {
            View::error(
                ...
                match (true) {
                    ...
                    // Bireye ekibin iç işleyişi anlatılmaz; ne yapacağı söylenir.
    ...
    private function visibilityFilter(array $actor): array
    {
        ...
        // Birey: yalnız kendi kaydına bağlı seanslar. Bağ users.id ↔ clients.user_id
        // üzerinden gider; panel hesabı hiçbir birey kaydına bağlı değilse
     ...
     *
     * Rol açıkça aranır: `payment.view.own` artık bireyde da var ve o yetki
     * tek başına ücret yazma hakkı vermez. Kimlik karşılaştırması bunu bugün
     * zaten engelliyor (bireyin hesabı bir randevunun therapist_id'si olamaz)
