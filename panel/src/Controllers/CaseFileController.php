...
/**
 * Birey dosyası — başvuru nedeni, öykü, formülasyon, plan.
 *
 ...
 * Kayıt (birey, terapist) çifti başına tektir — devir hâlinde devralan terapist
...
final class CaseFileController
{
    ...
    private function findClient(int $clientId, array $actor): array
    {
        ...
        if ($client === null) {
            View::error(404, 'Birey bulunamadı', 'Dosya yalnız kendi bireyleriniz için açılabilir.');
            exit;
        }
        return $client;
    }
