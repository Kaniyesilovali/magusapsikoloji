...
Kartlarda kişi yok; her yazının konusunu ilk bakışta ele veren bir nesne ya da mekân var:
optik cevap kâğıdı (sınav kaygısı), defterin üzerinde ilaç şişesi (psikolog mu psikiyatrist mi),
yanmış kibrit çöpleri (tükenmişlik), boş sınıf (okul fobisi), açık bavul (uluslararası öğrenciler) gibi.
...
kart oranına (16:9) kırpılmış, ~800×450 px JPEG olarak repoda durur. TR ve EN yazılar aynı dosyayı paylaşır.
...
| magusa-uluslararasi-ogrenciler-psikolojik-destek.jpg | Yolculuk için hazırlanmış, açık duran bir bavul | photo-1502301197179-65228ab57f78 |
